...
public class player_controller : MonoBehaviour
{
    ...
    void Move()
    {
        float x = Input.GetAxisRaw("Horizontal"); //input takes which buttons the player is pressing
        //horizontal is a or d or left right keys
        float y = Input.GetAxisRaw("Vertical"); //vertical is w s or top bottom
